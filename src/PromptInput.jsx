...
export default function PromptInput({ mood, setResponse }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true)
    try {
      // This will now just set a basic response
      // The content selection will happen in AIResponse
      setResponse({
        mood,
        text: `I see you're feeling ${mood}. What type of content would you like?`,
        type: 'selection'
      })
    } catch (error) {
      console.error(error)
